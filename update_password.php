...
function success() {
    //lert(document.getElementById('confirm').value);
    //var dats = "<?php echo $vv; ?>";
    //alert(dats);
    Swal.fire({
        title: "Successful!",
...
<?php
if($_SERVER["REQUEST_METHOD"]=="GET"){ // Check if the form is submitted via POST
if(isset($_GET["pass"])) {
    $value4 = $_GET['pass'];
    $value5 = $_GET['pass1'];
    $value6 = $_GET['pass2'];
