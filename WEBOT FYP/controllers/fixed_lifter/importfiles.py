...
#qrcode1 and qrcode1s for outbound purpose
#qecode_for_inbound for inbound purpose
...
def qrcode():
  ...
  if decoded_info:
      ...
      if decoded_info not in qr_code_content:
          print(f"In Bound {current_time}: New QR code found! Content: {decoded_info}")
          qr_code_content.add(decoded_info)
          qr_code_count += 1
          with open("notes.txt", "ab") as notes_file:  # Use 'ab' for binary write mode
              notes_file.write(f"In Bound {current_time}: {decoded_info} (Count: {qr_code_count})\n".encode('utf-8'))
          if decoded_info == b'\x01\x02\x03':
              print("Binary content matches: 0x010203")
          elif decoded_info == b'\x04\x05\x06':
              print("Binary content matches: 0x040506")
          bingss = decoded_info
          return bingss
      else:
          ...
          if os.path.exists(file_paths):
            with open(file_paths, 'r') as file:
              ...
              if id is not None:
                print(f"Name for ID {ids}: {id}")
                del data[ids]
                new_data = {str(yss)+" "+str(xs): str(binggg)}
      ...
      if(cos == 2): 
       ...
       # else:
        ...
        if os.path.exists(file_paths):
          with open(file_paths, 'r') as file:
            data = json.load(file) 
            new_data = {str(bb)+" "+str(rowe): str(lolol)}
            data.update(new_data)
  ...
  while supervisor.step(TIME_STEP) != -1:
    ...
    if(check == 22):
      ...
      for i in range(43):
        for j in range(65):
          if (matrix[i][j] == 0):
            ...
            with open(file_paths, 'w') as file:
              file.write('Moving')
            print(f"Moving, Save Successfully")
            check = 0
      ...
      if(macount == 2795):
        ...
        with open(file_paths, 'w') as file:
          file.write('Empty')
        print(f"Empty, Save Successfully")
      ...
      if(cos == 0): 
        ...
        if(checku == 1):
          if(bb == 0 or bb == 2 or bb == 4 or bb == 6 or bb == 8 or bb == 10 or bb == 12 or bb == 14 or bb == 16 or bb == 18 or bb == 20 or bb == 22 or bb == 24 or bb == 26 or bb == 28 or bb == 30 or bb == 32 or bb == 34 or bb == 36 or bb == 38 or bb == 40 or bb == 42):             
            ...
            if(qw == bb and sst < 12):
              if(rowe < 24):
                lm2s = 29.01-(2.9*(sst-1))
              elif(rowe >= 24 and rowe < 51):
                lm2s = 29.01-(2.9*(sst-1))-0.02
              elif(rowe >= 51):
                lm2s = 29.01-(2.9*(sst-1))-0.04
              lm3s = 1.21
              check = 1
              
            elif(qw == bb and sst >= 12):
              if(rowe < 24):
                lm2s = 29.01-(2.9*(sst - 12))
              elif(rowe >= 24 and rowe < 51):
                lm2s = 29.01-(2.9*(sst - 12))-0.02
              elif(rowe >= 51):
                lm2s = 29.01-(2.9*(sst - 12))-0.04
              lm3s = -1.87
              check = 1
    ...
    if(check == 1):
      ...
      if(count == 0):
        if(bb == 1 or bb == 3 or bb == 5 or bb == 7 or bb == 9 or bb == 11 or bb == 13 or bb == 15 or bb == 17 or bb == 19 or bb == 21):
          values = lidar_search()
        elif(bb == 23 or bb == 25 or bb == 27 or bb == 29 or bb == 31 or bb == 33 or bb == 35 or bb == 37 or bb == 39 or bb == 41 or bb == 43):
          values = lidar_searchs() 
        elif(bb == 0 or bb == 2 or bb == 4 or bb == 6 or bb == 8 or bb == 10 or bb == 12 or bb == 14 or bb == 16 or bb == 18 or bb == 20):  
          values = lidar_search1()
        elif(bb == 22 or bb == 24 or bb == 26 or bb == 28 or bb == 30 or bb == 32 or bb == 34 or bb == 36 or bb == 38 or bb == 40 or bb == 42):
          values = lidar_searchs1()
        if(values > 1):
          machine1()
        #step3
      ...
      #step4
        ...
        if(rowe < 30):
          ...
          passive_wait((rowe*3.64)+2+5.4+7)
        count = 2.1
        #step9
      elif(count == 2.1):
        if ds_checker.getValue() == 1000:
